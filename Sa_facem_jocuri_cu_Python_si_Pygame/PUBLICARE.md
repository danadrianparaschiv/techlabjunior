...
```sh
gh workflow run publish-python-pygame.yml --repo danadrianparaschiv/techlabjunior --ref main -f source_ref=main
gh run list --repo danadrianparaschiv/techlabjunior --workflow publish-python-pygame.yml
```
...
Pagina de lectură: /biblioteca/jocuri-cu-python-si-pygame.
