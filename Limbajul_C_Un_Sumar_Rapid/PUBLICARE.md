...
```sh
gh workflow run publish-c-quick-reference.yml --repo danadrianparaschiv/techlabjunior --ref main -f source_ref=main
gh run list --repo danadrianparaschiv/techlabjunior --workflow publish-c-quick-reference.yml
```
...
Pagina de lectură: /biblioteca/limbajul-c-un-sumar-rapid.
