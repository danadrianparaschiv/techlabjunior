...
```sh
gh workflow run publish-learn-scratch.yml --repo danadrianparaschiv/techlabjunior --ref main -f source_ref=main
gh run list --repo danadrianparaschiv/techlabjunior --workflow publish-learn-scratch.yml
```
...
Pagina de lectură: /biblioteca/invata-sa-programezi-cu-scratch.
