...
```sh
gh workflow run publish-website-builder.yml --repo danadrianparaschiv/techlabjunior --ref main -f source_ref=main
gh run list --repo danadrianparaschiv/techlabjunior --workflow publish-website-builder.yml
```
...
Pagina de lectură: /biblioteca/constructorul-de-siteuri.
